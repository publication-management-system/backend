package com.pms.publicationmanagement.services.tokens;
...
public class TokenService {
    ...
    public String generateToken(User user) {
        ...
        return JWT.create()
                ...
                .withClaim("institutionId", user.getInstitution().getId())
    ...
    public UserTokenDetails decodeToken(String token) {
        ...
        return new UserTokenDetails(id, institutionId, email, UserType.valueOf(role));
    }
